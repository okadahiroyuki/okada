...
"""
    head_track.py - Version 0.9 2015-10-01

    Move the head to track a target published on the /roi topic.
    
    Created for the TRCP Project: http://www.okadanet.org
    Copyright (c) 2015 Hiroyuki Okada.  All rights reserved.
...
class HeadTrack():
    def __init__(self):
        ...
        self.max_pan = rospy.get_param("~max_pan", radians(120))
        self.min_pan = rospy.get_param("~min_pan", radians(-220))
        self.max_tilt = rospy.get_param("~max_tilt", radians(30))
...
if __name__ == '__main__':
    try:
        ...
        rospy.loginfo("Head track node terminated.")
